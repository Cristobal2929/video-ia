...
tema = st.text_input("🧠 Tema del vídeo:", placeholder="Ej: Las leyes de la riqueza")
...
if st.button("🚀 CREAR OBRA MAESTRA (MOTOR V58)"):
    if not tema: st.error("⚠️ Escribe un tema, jefe.")
        ...
        with log:
            ...
            if len(lista_palabras) > 60: guion = " ".join(lista_palabras[:60])
