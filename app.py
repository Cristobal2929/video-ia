...
st.set_page_config(page_title="Fenix Studio V109", layout="centered")
...
st.markdown('<div class="pro-title">FENIX STUDIO V109 🛡️</div>', unsafe_allow_html=True)
